...
function updateCounter () {
  let counter = parseInt(jquery__WEBPACK_IMPORTED_MODULE_0___default()('#count').text()) || 0;
  counter++;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('#count').text(`${counter} clicks on the button`);
};

let debounce = lodash__WEBPACK_IMPORTED_MODULE_1___default().debounce(updateCounter, 500);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('<p>').attr('id', 'count').appendTo('body');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').append('<p>Copyright - Holberton School</p>');

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('button').on('click', debounce);
});
